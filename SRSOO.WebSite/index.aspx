...
<script src="Sciript/data/indexdata.js"></script>
...
<body style="padding: 0px; background: #EAEEF5;">
    ...
    <div id="topmenu" class="l-topmenu">
        <div class="l-topmenu-logo">SRS导航主页</div>
        <div class="l-topmenu-welcome">
            <a href="" class="l-link2">修改密码</a>
    ...
    <div id="layout1" style="width: 99.2%; margin: 0 auto; margin-top: 4px;">
        <div position="left" title="主要菜单" id="accordion1">
            <div title="学生选课" class="l-scroll">
                <ul id="tree1" style="margin-top: 3px;">
            </div>
            <div title="系统管理">
                <div style="height: 7px;"></div>
                <a class="l-link" href="javascript:f_addTab('listpage','用户管理','pages/userManage.aspx')">列表页面</a>
                <a class="l-link" href="" target="_blank">系统日志</a>
            </div>
        </div>
